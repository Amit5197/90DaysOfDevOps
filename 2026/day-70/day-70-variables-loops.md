...
![image](images/task1-override-var.png)
---
...
![image](images/task3_all_facts.png)
...
- `group_vars/` and `host_vars/` directory structure
  ...
  ![image](images/task2_dir_structure.png)
