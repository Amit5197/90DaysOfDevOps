...
helm list
```
![image](images/cluster_info_hlm_list.png)
...
![image](images/helm_stable_mysql.png)
...
![image](images/helm_install_stable_mysql.png)
...
![image](images/helm_create_mysql.png)
...
```
![image](images/mysql_show_values.png)
...
```
![image](images/uninstall_mysql_v2.png)
---
...
![image](images/mysql_upgrade.png)

Check the revision history:
```bash
helm history bankapp-mysql
```
![image](images/mysql_history.png)
...
![image](images/mysql_rollback.png)
