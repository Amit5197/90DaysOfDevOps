...
![image](images/idempontent.png)


**Reflect and document:**
1. How many total tasks ran?
- A total of `41 task` executions ran across all hosts
...
- I would add `SSL using Certbot`, enable `monitoring with Prometheus and Grafana`, configure log rotation, and use `Docker Compose for better multi-container management`
...
![iamge](images/dir.png)

**How you used tags for selective deployment**

- I used Ansible tags like common, docker, and nginx to run specific parts of the playbook. 
- For example, I can run only Docker setup using --tags docker instead of executing the full playbook.”
