...
![image](images/task4imports3.png)
...
2. Go to the **AWS console** and manually:
   ...
   ![image](images/task6addnewtg.png)
3. Run:
```bash
terraform plan
```
