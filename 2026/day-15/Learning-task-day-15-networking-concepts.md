...
- Last column shows the actual IPv4 addresses (A Records).
  ...
  <img width="757" height="517" alt="image" src="https://github.com/user-attachments/assets/bc7cfe43-759c-4db9-82ba-5938aaaa5de0" />
...
- 32-bit number divided into 4 octets: `192.160.1.10`  
...
| Private     | Used in local networks          | 192.160.1.10 |
...
- Example private IP: `172.31.19.105`

 <img width="1042" height="287" alt="image" src="https://github.com/user-attachments/assets/ba227b33-4eb3-4a94-8c60-ed5881b99ff4" />
...
- Example: `22 → SSH`, `80 → HTTP`
 ...
 <img width="1573" height="326" alt="image" src="https://github.com/user-attachments/assets/63793018-b6b6-4467-992b-3ea2ae09caf1" />
