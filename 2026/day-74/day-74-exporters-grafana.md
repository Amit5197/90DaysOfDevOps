...
![image](images/exporter_healthy.png)

Check Prometheus Targets page -- `node-exporter` should show as `UP`.

![image](images/node_exporter_up.png)
...
![image](images/node_exporter_spent_idle.png)
...
![image](images/network_receive.png)
---
...
![image](images/cadvisor_webui.png)
...
![image](images/cpu_usage_percont.png)

# Memory usage per container
container_memory_usage_bytes{id!="/", id=~".*docker.*"}

![image](images/memory_usage_percont.png)

# Network received bytes per container
rate(container_network_receive_bytes_total{name!=""}[5m]) `not wokring`

![image](images/nw_recev_cont.png)

# Which container is using the most memory?
topk(3, container_memory_usage_bytes{id!="/", id=~".*docker.*"})

![image](images/most_cnt.png)
...
![image](images/prom_data_grafana.png)
---
...
![image](images/DevOps_Observability_Overview.png)
---
...
![image](images/node_exporter_full.png)
